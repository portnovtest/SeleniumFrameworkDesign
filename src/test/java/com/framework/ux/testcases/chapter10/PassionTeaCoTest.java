package com.framework.ux.testcases.chapter10;

import com.framework.ux.utils.chapter10.CreateDriver;
import com.framework.ux.utils.chapter10.Global_VARS;
import com.framework.ux.utils.chapter10.JSONDataProvider;
import com.framework.ux.utils.chapter10.PassionTeaCoWelcomePO;
...
public class PassionTeaCoTest {
    ...
    protected void testSetup(@Optional(Global_VARS.BROWSER)String browser,
        ...
        CreateDriver.getInstance().setDriver(Global_VARS.DEF_BROWSER,
                Global_VARS.DEF_PLATFORM,Global_VARS.DEF_ENVIRONMENT);
    }
    ...
    protected void testClassSetup(ITestContext context) throws Exception {
        ...
        welcome = new PassionTeaCoWelcomePO<>();
    ...
    @Test(groups = {"PASSION_TEA"},dataProvider = "fetchData_JSON",
            dataProviderClass = JSONDataProvider.class,enabled = true)
    public void tc001_passionTeaCo(String rowID, String description, JSONObject testData) throws Exception {
    ...
    @Test(groups = {"PASSION_TEA"},dataProvider = "fetchData_JSON",
            dataProviderClass = JSONDataProvider.class,enabled = true)
    public void tc002_passionTeaCo(String rowID, String description, JSONObject testData) throws Exception {

        // verify image source
        welcome.verifyImgSrc(PassionTeaCoWelcomePO.WELCOME_PAGE_IMG.valueOf(testData.get("img").toString()),
    ...
    @Test(groups = {"PASSION_TEA"},dataProvider = "fetchData_JSON",
            dataProviderClass = JSONDataProvider.class,enabled = true)
    public void tc003_passionTeaCo(String rowID, String description, JSONObject testData) throws Exception {
    ...
    @Test(groups = {"PASSION_TEA"},dataProvider = "fetchData_JSON",
            dataProviderClass = JSONDataProvider.class,enabled = true)
    public void tc004_passionTeaCo(String rowID, String description, JSONObject testData) throws Exception {
    ...
    @Test(groups = {"PASSION_TEA"},dataProvider = "fetchData_JSON",
            dataProviderClass = JSONDataProvider.class,enabled = true)
    public void tc005_passionTeaCo(String rowID, String description, JSONObject testData) throws Exception {
    ...
    @Test(groups = {"PASSION_TEA"},dataProvider = "fetchData_JSON",
            dataProviderClass = JSONDataProvider.class,enabled = true)
    public void tc006_passionTeaCo(String rowID, String description, JSONObject testData) throws Exception {
